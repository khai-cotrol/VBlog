(function () {
    ...
    GaugePointer = (function (_super) {
        ...
        GaugePointer.prototype.options = {strokeWidth: 0.035, length: 0.1, color: "#000000"};
    ...
    Gauge = (function (_super) {
        ...
        Gauge.prototype.set = function (value) {
            ...
            for (_j = 0, _len = value.length; _j < _len; _j++) {
                ...
                this.gp[i].value = val;
                this.gp[i++].setOptions({maxValue: this.maxValue, angle: this.options.angle});
            }
    ...
    window.AnimationUpdater = {
        elements: [], animId: null, addAll: function (list) {
