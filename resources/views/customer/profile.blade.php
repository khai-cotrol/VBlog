...
<div class="container emp-profile">
    <form method="post">
        <div class="row">
            ...
            <div class="col-md-2">
                <a class="profile-edit-btn" href="{{route('user.edit',$user->id)}}">Edit Profile</a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
                        ...
                        @foreach($allPost as $posts)
                            <div class="col-md-12">
                                <div class="blog-entry ftco-animate d-md-flex">
                                    <figure>
                                        <a href="{{route('commentByPost',$posts->id)}}" class="img img-2"> <img
                                                src="{{asset('storage/'.$posts->image)}}"
                                    ...
                                    <div class="text text-2 pl-md-4">
                                        ...
                                        <div class="meta-wrap">
                                            <p class="meta">
                                                ...
                                                <span><a href="{{route('commentByPost',$posts->id)}}"></a></span>
                                            </p>
                                        </div>
                                        ...
                                        <div class="more-post-optns">
                                            ...
                                            @if(\Illuminate\Support\Facades\Auth::user()->id==$posts->user->id)
                                                <ul>
                                                    <li><a class="a o" href="{{route('post.edit',$posts->id)}}">Edit
                                                            Post</a></li>
                                                    <li><a class="a b" href="{{route('post.delete',$posts->id)}}"
